...
\textbf{Rules} & \textbf{Tautology} & \textbf{Usage}\\
\hline
\textbf{Modus Ponens} & $(P \land (P\rightarrow Q))\rightarrow Q$ & \begin{tabular}{l}
$P$\\
$P \rightarrow Q$\\
\hline
$\therefore Q$\\
...
\textbf{Hypothetical Syllogism} & $((P \rightarrow Q) \land (Q \rightarrow R)) \rightarrow (P \rightarrow R)$
&\begin{tabular}{l}
$P \rightarrow Q$\\
$Q \rightarrow R$\\
\hline
...
\textbf{Conjunction} & $P \land Q \rightarrow P \land Q$ & \begin{tabular}{l}
$P$\\
$Q$\\
\hline
$\therefore P \land Q$\\
...
\hline
  ...
  \textbf{Addition} & $P \rightarrow (P \lor Q)$ & \begin{tabular}{l}
  $P$\\
  \hline
  $\therefore P \lor Q$\\
  \end{tabular}\\
...
\hline
  ...
  \textbf{Simplification} & $P \land Q \rightarrow P$  & \begin{tabular}{l}
  $P \land Q$\\
  \hline
  $\therefore P$\\
  \end{tabular}
